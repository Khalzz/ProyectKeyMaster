...
public class LevelSongs : MonoBehaviour
{
    ...
    // level test
    public List<int> dLevelTest = new List<int>() {269, 334, 391, 451, 515, 583, 644, 705, 894, 921, 269, 334, 391, 451, 515, 583, 644, 705, 894, 921};
    public List<int> fLevelTest = new List<int>() {269, 334, 391, 451, 515, 583, 644, 705, 894, 921, 269, 334, 391, 451, 515, 583, 644, 705, 894, 921};
    public List<int> spaceLevelTest = new List<int>() {269, 334, 391, 451, 515, 583, 644, 705, 894, 921, 269, 334, 391, 451, 515, 583, 644, 705, 894, 921};
    public List<int> jLevelTest = new List<int>() {269, 334, 391, 451, 515, 583, 644, 705, 894, 921, 269, 334, 391, 451, 515, 583, 644, 705, 894, 921};
    public List<int> kLevelTest = new List<int>() {269, 334, 391, 451, 515, 583, 644, 705, 894, 921, 269, 334, 391, 451, 515, 583, 644, 705, 894, 921};
    // level test
